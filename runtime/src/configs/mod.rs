...
impl pallet_tasks::Config for Runtime {
    ...
    type MaxTasksPerStatus = ConstU32<10000>;
...
impl pallet_reputation::Config for Runtime {
    ...
    type Balance = Balance;
    type Moment = u64;
    type MaxCommentLength = ConstU32<1024>;
    type MaxEvaluationsPerTask = ConstU32<100>;
    type MaxReputationHistory = ConstU32<1000>;
    type BaseReputationScore = ConstU32<10>;
    type DifficultyBonus = ConstU32<2>;
    type CancellationPenalty = ConstU32<5>;
    type Randomness = pallet_insecure_randomness_collective_flip::Pallet<Runtime>;
}
